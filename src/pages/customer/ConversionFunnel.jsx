...
import { FunnelOutlined, ReloadOutlined, DownloadOutlined } from '@ant-design/icons';
import * as echarts from 'echarts';
import dayjs from 'dayjs';
import { getLeadStatistics } from '../../services/api';
...
const ConversionFunnel = () => {
  ...
  const fetchStatistics = async () => {
    try {
      ...
      const response = await getLeadStatistics(params);
      if (response.success) {
